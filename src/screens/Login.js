...
const LoginScreen = ({navigation}) => {
    ...
    const handleCustomerUserLogin = async (Customer) => {
        ...
        console.log("in handleCompanyUserLogin", res.data);
    if(res.data.code === 3){
        ...
        if (
            ...
            res.data.userDetails.TypeOfUser === "Admin"
        ) {
            setprogressVisible(false);
                    ...
                    <View>
                        ...
                        <TouchableOpacity onPress={handleSubmit}>
                            <View style={styles.loginBtnStyle}>
                                <AppText style={{alignSelf:"center",fontWeight:'bold',color:colors.white}}>Login</AppText>
                            </View>
                        </TouchableOpacity>
                        <AppButton
    ...
    return (
        <ScrollView>
            <SafeAreaView style={styles.container}>
                ...
                <AppText style={{textAlign: "center", marginTop: 60}}>Login To Your Account</AppText>
