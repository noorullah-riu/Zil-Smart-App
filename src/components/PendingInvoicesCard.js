...
const PendingInvoicesCard = ({
  ...
  return (
    <View style={styles.card1}>
      <TouchableOpacity
        onPress={() =>
          navigation.navigate("PendingRecoveryDetail", {
            cardCode,
            invoiceDate,
          })
        }
      >
        ...
        <AppRow style={styles.row1}>
          <AppText style={styles.p2}># {item.CardCode}</AppText>
        ...
        {/* <AppText style={styles.p6}>
          Order Date: <AppText style={styles.p6b}>{item.ReqDate}</AppText>
        </AppText>
        <AppText style={styles.p7}>
          Delivery Date: <AppText style={styles.p7b}>{item.DocDueDate}</AppText>
        </AppText>
        <AppText style={styles.p7}>
