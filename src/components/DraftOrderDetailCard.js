...
const DraftOrderDetailCard = ({ item }) => {
    ...
    <View style={styles.container}>
      <AppRow>
        ...
        <AppColumn style={styles.c3}>
          <AppText style={styles.p7b}>{item.price}</AppText>
        </AppColumn>
        <AppColumn style={styles.c3}>
          <AppText style={styles.p7b}>{item.lineTotal}</AppText>
        </AppColumn>
      </AppRow>
    </View>
  );
...
export default DraftOrderDetailCard;
